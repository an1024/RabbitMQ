...
public class Consumer2 {
    ...
    public void Consum() throws Exception {
         ...
         *
         */
        channel.queueDeclare("topics-queue-2",true,false,false,null);
        ...
        DefaultConsumer consume = new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("对快的动物和兔子感兴趣，接收到消息： "+ new String(body,"UTF-8"));
        ...
        //true 开启自动ACK false关闭ACK
        channel.basicConsume("topics-queue-2",false,consume);

        System.out.println("对快的动物感兴趣，监听队列。。。。。。。。。。");
        System.in.read();
        //释放资源
        channel.close();
        connection.close();
