...
public class Consumer1 {
    ...
    public void Consum() throws Exception {
         ...
         *
         */
        channel.queueDeclare("topics-queue-1",true,false,false,null);
        ...
        DefaultConsumer consume = new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("对红色动物感兴趣，接收到消息： "+ new String(body,"UTF-8"));
        ...
        channel.basicConsume("topics-queue-1",false,consume);

        System.out.println("对红色动物感兴趣，监听队列。。。。。。。。。。");
        System.in.read();
        //释放资源
        channel.close();
        connection.close();
